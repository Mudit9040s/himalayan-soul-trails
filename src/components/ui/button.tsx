  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        // Custom HIMO variants
        hero: "bg-gradient-gold text-primary-foreground font-semibold tracking-wide hover:shadow-glow hover:scale-105 active:scale-100",
        heroOutline: "border-2 border-foreground/30 bg-transparent text-foreground font-medium tracking-wide hover:border-primary hover:text-primary hover:bg-primary/5",
        gold: "bg-primary text-primary-foreground font-semibold hover:bg-accent hover:shadow-glow",
